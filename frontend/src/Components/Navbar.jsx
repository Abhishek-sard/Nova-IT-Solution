...
const Navbar = () => {
  ...
  const linkClasses = "hover:text-gray-300 transition-colors duration-200";
  const activeClasses = "text-gray-300 border-b-2 border-gray-300";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 text-white">
        ...
        <NavLink
          to="/"
          className="flex items-center gap-2 ml-1 sm:ml-2 md:ml-4"
        >
          <img
            src="/Logo White.png"
            alt="NOVA logo"
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-[#2c6e32] text-white px-4 sm:px-6 py-4">
