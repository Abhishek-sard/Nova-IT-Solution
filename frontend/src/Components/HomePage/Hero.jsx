...
import NovaLogo from "../../assets/NOVA logo.png"; // better to import instead of using string
  ...
  return (
    <>
          ...
          <div className="space-y-4 sm:space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8 justify-center md:justify-start">
              ...
              <a
                ...
                text-sm sm:text-base lg:text-lg text-center transition duration-300"
              >
                Learn More
              </a>
            </div>
      ...
      <div className="fixed bottom-3 right-3 z-50">
        <a
          href="https://wa.me/9811342113?text=Hello%20How%20can%20I%20help%20you?"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
