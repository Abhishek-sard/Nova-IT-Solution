...
const Hero = () => {
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                {/* Left: Text */}
                ...
                {/* Right: Image */}
                <div className="flex justify-center md:justify-end mt-12 md:mt-16 lg:mt-20">
                    <img
                        src={Logo1}
